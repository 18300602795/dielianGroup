package com.etsdk.app.huov7.chat.pickerimage;
...
import com.etsdk.app.huov7.chat.pickerimage.adapter.PickerPreviewPagerAdapter;
import com.etsdk.app.huov7.chat.pickerimage.model.PhotoInfo;
import com.etsdk.app.huov7.chat.pickerimage.model.PickerContract;
import com.etsdk.app.huov7.chat.pickerimage.utils.BitmapDecoder;
import com.etsdk.app.huov7.chat.pickerimage.utils.Extras;
import com.etsdk.app.huov7.chat.pickerimage.utils.ImageUtil;
import com.etsdk.app.huov7.chat.pickerimage.utils.PickerUtil;
import com.etsdk.app.huov7.chat.pickerimage.utils.RequestCode;
import com.etsdk.app.huov7.chat.pickerimage.view.BaseZoomableImageView;
import com.etsdk.app.huov7.chat.pickerimage.view.ToolBarOptions;
import com.etsdk.app.huov7.chat.pickerimage.view.UIView;
import com.etsdk.app.huov7.chat.utils.imagepicker.view.ViewPagerFixed;
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.picker_image_preview_photos_select) {
            ...
            if (selectPhotoList != null && selectPhotoList.size() == 0) {
               ...
               T.s(PickerAlbumPreviewActivity.this, "请至少选择一张发送");
            }else {
